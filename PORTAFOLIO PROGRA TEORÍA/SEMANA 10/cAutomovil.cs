...
public class Class1
{
	public Class1()
	{
        ...
        string mensajeGasolina, mensajeEncendido, mensajeCambioLLanta, colorNuevo, fasePintura, mensajeColor; 
        bool comprarLlanta, cambiarColor;
        bool lijar, masilla, colorgris, pulir, pintar; 
        ...
        void cambiarColor(string fasePintura)
        {
        ...
        {
            if (lijar == true && color == "lijar")
            {
                mensajeColor = "El siguiente paso es agregarle la masilla"
            }
            else
            {
                if (masilla == true && color == "masilla")
                {
                    mensajeColor = "Se prosigue a agregar el color gris"
                }
                else
                {
                    if (colorgris == true && color == "colorgris")
                    {
                        mensajeColor = "se prosigue a pulir el carro"
                    }
                    else
                    {
                        if (pulir == true && color == "pulir")
                        {
                            mensajeColor = "Se prosigue a pintar el carro"
                        }
                        else
                        {
                            if (pintar == true && color == "pintar")
                            {
                                mensajeColor = "Carro finalmente pintado"
                            }
                        }
                    }
                }
